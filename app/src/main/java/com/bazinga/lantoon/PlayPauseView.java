...
public class PlayPauseView extends AppCompatImageView {
    ...
    private void Init(Context context) {
        mPlayToPauseAnim = AnimatedVectorDrawableCompat.create(context, R.drawable.anim_vector_play_to_pause);
        mPauseToPlay = AnimatedVectorDrawableCompat.create(context, R.drawable.anim_vector_pause_to_play);
